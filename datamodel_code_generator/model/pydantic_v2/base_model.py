...
from typing import Any, ClassVar, DefaultDict, Dict, List, NamedTuple, Optional, Set

from pydantic import Field
from typing_extensions import Literal

from datamodel_code_generator.model.base import UNDEFINED, DataModelFieldBase
from datamodel_code_generator.model.pydantic.base_model import BaseModelBase
    ...
    def __init__(
        ...
        *,
        ...
        if config_parameters:
            ...
            self.extra_template_data["config"] = ConfigDict.parse_obj(
                config_parameters
            )  # pyright: ignore [reportArgumentType]
            self._additional_imports.append(IMPORT_CONFIG_DICT)

    def _get_config_extra(self) -> Optional[Literal["'allow'", "'forbid'", "'ignore'"]]:
